...
public class PreviewAndReportsMediumTest {
  ...
  public BatchMediumTester tester = BatchMediumTester.builder()
    ...
    // Existing issue
    .addPreviousIssue(org.sonar.batch.protocol.input.BatchInput.PreviousIssue.newBuilder().setKey("xyz")
      ...
      .build())
    // Resolved issue
    .addPreviousIssue(org.sonar.batch.protocol.input.BatchInput.PreviousIssue.newBuilder().setKey("resolved")
      .setComponentKey("sample:xources/hello/HelloJava.xoo")
      .setRuleRepository("xoo")
      .setRuleKey("OneIssuePerLine")
      .setLine(1)
      ...
      .build())
    // Manual issue
    .addPreviousIssue(org.sonar.batch.protocol.input.BatchInput.PreviousIssue.newBuilder().setKey("manual")
      .setComponentKey("sample:xources/hello/HelloJava.xoo")
