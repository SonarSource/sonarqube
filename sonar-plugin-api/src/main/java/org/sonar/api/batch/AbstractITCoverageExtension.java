 ...
 */
@Deprecated
public abstract class AbstractITCoverageExtension implements ITCoverageExtension {

  /**
   * The plugin key to retrieve the coverage engine to be used
   */
  public static final String PARAM_PLUGIN = "sonar.core.codeItCoveragePlugin";

  /**
   * The default value for the code coverage plugin
   */
  public static final String DEFAULT_PLUGIN = "jacoco";
   ...
   */
  @Deprecated
  public AbstractITCoverageExtension(Plugins plugins) {
  }

  public AbstractITCoverageExtension() {
  }
