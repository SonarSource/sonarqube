...
public class DefaultActiveRules implements ActiveRules {
  ...
  public Collection<ActiveRule> findAll() {
    return Collections.unmodifiableCollection(activeRulesByRepository.values());
  }

  @Override
  public Collection<ActiveRule> findByRepository(String repository) {
    return Collections.unmodifiableCollection(activeRulesByRepository.get(repository));
  }

  @Override
  public Collection<ActiveRule> findByLanguage(String language) {
    return Collections.unmodifiableCollection(activeRulesByLanguage.get(language));
  }
