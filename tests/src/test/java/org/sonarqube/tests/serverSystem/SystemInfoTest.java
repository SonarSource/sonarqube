...
public class SystemInfoTest {
  ...
  public void test_system_info_page() {
    ...
    page.getCardItem("Web")
      .shouldHaveSections("Web JVM Properties", "Web JVM State");

    page.getCardItem("Compute Engine")
      .shouldHaveSections("Compute Engine Database Connection", "Compute Engine JVM State", "Compute Engine Tasks");

    page.getCardItem("Search")
      .shouldHaveSections("Search State", "Search Statistics");
  }
