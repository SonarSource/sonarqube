...
(function() {
  ...
  requirejs(['backbone', 'backbone.marionette', 'handlebars', 'collections/quality-gates', 'collections/metrics', 'views/quality-gate-sidebar-list-view', 'router', '../handlebars-extensions'], function(Backbone, Marionette, Handlebars, QualityGates, Metrics, QualityGateSidebarListItemView, QualityGateRouter) {
    var App;
