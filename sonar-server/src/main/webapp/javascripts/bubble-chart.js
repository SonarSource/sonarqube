...
(function() {
    ...
    SonarWidgets.BubbleChart.prototype.render = function(container) {
        ...
        x
            .domain(d3.extent(this.data(), function(d) { return d.xMetric }))
            .range([0, availableWidth]);

        y
            .domain(d3.extent(this.data(), function(d) { return d.yMetric }))
            .range([availableHeight, 0]);

        size
            .domain(d3.extent(this.data(), function(d) { return d.sizeMetric }))
            .range([10, 50]);
        ...
        items
            ...
            .append('circle')
                .attr('r', function(d) { return size(d.sizeMetric) })
        ...
        items.sort(function(a, b) { return b.sizeMetric - a.sizeMetric });
        ...
        gyAxis.attr('transform', trans(50 - this.margin().left, 0));
        ...
        gyAxis.append('text')
            ...
            .style('font-weight', 'bold')
            .style('text-anchor', 'middle')
            .attr('transform', trans(-35, availableHeight / 2) + ' rotate(-90)');
    ...
    SonarWidgets.BubbleChart.defaults = {
        width: 350,
        height: 150,
        margin: { top: 60, right: 10, bottom: 50, left: 60 },
        xLog: false,
        yLog: false,
        bubbleColor: '#4b9fd5',
