...
public class SourcesShowWsHandlerTest {
  ...
  public void setUp() throws Exception {
    tester = new WsTester(new SourcesWs(new SourcesShowWsHandler(sourceDecorator)));
  }

  @Test
  public void show_source() throws Exception {
    String componentKey = "org.apache.struts:struts:Dispatcher";
    when(sourceDecorator.getDecoratedSourceAsHtml(componentKey)).thenReturn(newArrayList(
      "/*",
      " * Header",
      " */",
      "",
