...
public class SyntaxHighlightingSensorTest {
  ...
  public void testExecution() throws IOException {
    ...
    FileUtils.write(symbol, "1:0:1:3:k\n2:0:2:10:cppd\n\n#comment");
    DefaultInputFile inputFile = new TestInputFileBuilder("foo", "src/foo.xoo")
      .setLanguage("xoo")
      .setModuleBaseDir(baseDir.toPath())
      .initMetadata(" xoo\nazertyazer\nfoo")
    ...
    assertThat(context.highlightingTypeAt("foo:src/foo.xoo", 1, 2)).containsExactly(TypeOfText.KEYWORD);
    assertThat(context.highlightingTypeAt("foo:src/foo.xoo", 2, 7)).containsExactly(TypeOfText.CPP_DOC);
  }
}
