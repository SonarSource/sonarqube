...
public class HardCodedSecurityRuleSensor extends AbstractXooRuleSensor {

  public static final String RULE_KEY = "S2184";

  public HardCodedSecurityRuleSensor(FileSystem fs, ActiveRules activeRules) {
