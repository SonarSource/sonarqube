...
@Check(key = "UnusedPrivateMethod", title = "Unused private method", isoCategory = IsoCategory.Maintainability, priority = Priority.MAJOR, 
    description = "<p>Private methods that are never executed are dead code. " +
