...
@Check(key = "UnusedProtectedMethod", title = "Unused protected method", 
    isoCategory = IsoCategory.Maintainability, priority = Priority.MAJOR, 
    description = "<p>Protected methods that are never used by any classes " +
