...
public class MethodSignature {
  ...
  public MethodSignature(String methodName, Parameter returnType, Parameter... argumentTypes) {
    this(methodName, returnType, Arrays.asList(argumentTypes));
  }

  public MethodSignature(String methodName, Parameter returnType, List<Parameter> argumentTypes) {
