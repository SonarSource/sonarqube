...
public abstract class PermissionChange {
  ...
  protected PermissionChange(Operation operation, String organizationUuid, String permission, @Nullable EntityDto entity, PermissionService permissionService) {
