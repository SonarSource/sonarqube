...
export default class ActivationModalButton extends React.PureComponent<Props, State> {
  mounted: boolean;
  ...
  render() {
    ...
    return (
      <>
        ...
        {this.state.modal && (
          <Modal contentLabel={this.props.modalHeader} onRequestClose={this.handleCloseModal}>
