...
export default class CustomRuleCreationModal extends React.PureComponent<Props, State> {
  mounted: boolean;
            ...
            <table>
              <tbody>
                ...
                <tr className="property">
                  <th className="nowrap">
                    <h3>
                      {translate('key')} {!customRule && <em className="mandatory">*</em>}
                    </h3>
                  </th>
                  <td>
                    {customRule ? (
                      <span className="coding-rules-detail-custom-rule-key" title={customRule.key}>
                        {customRule.key}
                      </span>
                    ) : (
                      <input
