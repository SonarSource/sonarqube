...
import { Component, Organization, Status } from '../../../../js/types/types';
import { searchProjects } from '../../../../js/api/components';

import DeferredSpinner from '../../../components/ui/DeferredSpinner';

import { getComponentData } from '../../../../js/api/components';
import { getComponentNavigation } from '../../../../js/api/navigation';

import { getOrganization, getOrganizationNavigation } from "../../../../js/api/organizations";
import { HttpStatus } from '../../../../js/helpers/request';
...
import { Feature } from '../../../../js/types/features';
import { getBranches } from '../../../../js/api/branches';
import { getPullRequests } from '../../../../js/api/branches';
import { getBranchLikeQuery, isMainBranch, isPullRequest } from '../../../../js/helpers/branch-like';
import { isBranch } from '../../../../js/helpers/branch-like';
import { getAnalysisStatus, getTasksForComponent } from '../../../../js/api/ce';
import { Router } from '../../../../js/components/hoc/withRouter';
import withAvailableFeatures, { WithAvailableFeaturesProps } from '../../../../js/app/components/available-features/withAvailableFeatures';
import { Task, TaskStatuses, TaskTypes } from '../../../../js/types/tasks';
