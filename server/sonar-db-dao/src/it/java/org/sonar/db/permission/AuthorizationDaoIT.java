...
class AuthorizationDaoIT {
  ...
  private final AuthorizationDao underTest = new AuthorizationDao();
  ...
  private final String randomPermission = "p" + random.nextInt();
  ...
  @Test
  void countUsersWithGlobalPermissionExcludingGroup() {
  ...
  @Test
  void countUsersWithGlobalPermissionExcludingUser() {
  ...
  @Test
  void selectUserUuidsWithGlobalPermission() {
    // group g1 has the permission p1 and has members user1 and user2
    // user3 has the permission
    UserDto user1 = db.users().insertUser();
    UserDto user2 = db.users().insertUser();
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_for_group_AnyOne_for_non_existent_projects() {
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_for_user_for_non_existent_projects() {
    Set<String> randomNonProjectsSet = IntStream.range(0, 1 + Math.abs(random.nextInt(5)))
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_for_other_permission_for_group_AnyOne_on__project_without_any_permission_in_DB() {
    assertThat(underTest.keepAuthorizedEntityUuids(dbSession, randomPublicEntityUuids, null, randomPermission))
      .isEmpty();
  }

  @Test
  void keepAuthorizedEntityUuids_returns_empty_for_any_permission_for_user_on__project_without_any_permission_in_DB() {
    assertThat(underTest.keepAuthorizedEntityUuids(dbSession, randomPublicEntityUuids, user.getUuid(), randomPermission))
      .isEmpty();
  }

  @Test
  void keepAuthorizedEntityUuids_returns__project_if_user_is_granted_project_permission_directly() {
  ...
  @Test
  void keepAuthorizedEntityUuids_returns__project_if_user_is_granted_project_permission_by_group() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_for_user_and_any_permission_on_private_project_without_any_permission_in_DB() {
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_for_group_AnyOne_and_any_permission_on_private_project_without_any_permission_in_DB() {
    PermissionsTestHelper.ALL_PERMISSIONS
      .forEach(perm -> {
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_private_project_if_user_is_granted_project_permission_directly() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
  ...
  @Test
  void user_should_be_authorized() {
  ...
  @Test
  void group_should_be_authorized() {
    ProjectDto project1 = db.components().insertPrivateProject().getProjectDto();
    ProjectDto project2 = db.components().insertPrivateProject().getProjectDto();
    ProjectDto project3 = db.components().insertPrivateProject().getProjectDto();
  ...
  @Test
  void anonymous_should_be_authorized() {
  ...
  @Test
  void keepAuthorizedEntityUuids_should_be_able_to_handle_lots_of_projects() {
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_empty_for_non_existent_users() {
    ProjectDto project = random.nextBoolean() ? db.components().insertPublicProject().getProjectDto() :
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_empty_for_any_users_on__project_without_any_permission_in_DB() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_user_if_granted_project_permission_directly_on__project() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    ProjectDto otherProject = db.components().insertPublicProject().getProjectDto();
    UserDto otherUser = db.users().insertUser();
    db.users().insertProjectPermissionOnUser(user, randomPermission, project);
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_user_if_granted_project_permission_by_group_on__project() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    ProjectDto otherProject = db.components().insertPublicProject().getProjectDto();
    UserDto otherUser = db.users().insertUser();
    db.users().insertMember(group1, user);
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_empty_for_any_users_and_any_permission_on_private_project_without_any_permission_in_DB() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_user_if_granted_project_permission_directly_on_private_project() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
    ProjectDto otherProject = db.components().insertPublicProject().getProjectDto();
    UserDto otherUser = db.users().insertUser();
    db.users().insertProjectPermissionOnUser(user, randomPermission, project);
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_returns_user_if_granted_project_permission_by_group_on_private_project() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
    ProjectDto otherProject = db.components().insertPublicProject().getProjectDto();
    UserDto otherUser = db.users().insertUser();
    db.users().insertMember(group1, user);
  ...
  @Test
  void keep_authorized_users_returns_empty_list_for_role_and_project_for_anonymous() {
    ProjectDto project1 = db.components().insertPrivateProject().getProjectDto();
    ProjectDto project2 = db.components().insertPrivateProject().getProjectDto();
    ProjectDto project3 = db.components().insertPrivateProject().getProjectDto();
    UserDto user1 = db.users().insertUser("u1");
  ...
  @Test
  void keepAuthorizedUsersForRoleAndEntity_should_be_able_to_handle_lots_of_users() {
  ...
  @Test
  void countUsersWithGlobalPermissionExcludingGroupMember() {
  ...
  @Test
  void countUsersWithGlobalPermissionExcludingUserPermission() {
  ...
  @Test
  void selectEntityPermissionsObtainedViaManagedGroup_shouldOnlyReturnGroupLevelPermissions() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    ...
    Set<UserAndPermissionDto> permissionsViaGroup = underTest.selectEntityPermissionsObtainedViaManagedGroup(dbSession, project.getUuid()
      , "github");
  ...
  @Test
  void selectEntityPermissionsObtainedViaManagedGroup_shouldOnlyReturnPermissionsFromRightManagedInstanceProvider() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    GroupDto groupDto = insertExternalGroup("github");
    db.users().insertEntityPermissionOnGroup(groupDto, "groupLevelPermissionThatShouldBeRetrieved", project);
  ...
  @Test
  void selectEntityPermissionsObtainedViaManagedGroup_shouldOnlyReturnPermissionsFromExpectedProject() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    GroupDto groupDto = insertExternalGroup("github");
    db.users().insertEntityPermissionOnGroup(groupDto, "groupLevelPermissionThatShouldBeRetrieved", project);
  ...
  @Test
  void selectEntityPermissionsObtainedViaManagedGroup_whenSeveralRoles_shouldReturnsThemAll() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    GroupDto groupDto = insertExternalGroup("github");
    db.users().insertEntityPermissionOnGroup(groupDto, "groupLevelPermissionThatShouldBeRetrieved", project);
  ...
  @Test
  void selectEntityPermissionsObtainedViaManagedGroup_whenSeveralUsers_shouldReturnsThemAll() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    GroupDto groupDto = insertExternalGroup("github");
    db.users().insertEntityPermissionOnGroup(groupDto, "groupLevelPermissionThatShouldBeRetrieved", project);
  ...
  @Test
  void selectEntityPermissionsObtainedViaManagedGroup_whenMultipleGroupsAndUsers_shouldMergeEqualsObjects() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
    GroupDto groupDto = insertExternalGroup("github");
    db.users().insertEntityPermissionOnGroup(groupDto, "groupLevelPermissionThatShouldBeRetrieved", project);
  ...
  @Test
  void keepAuthorizedEntityUuids_filters_projects_authorized_to_logged_in_user_by_direct_permission() {
  ...
  @Test
  void keepAuthorizedEntityUuids_filters_projects_authorized_to_logged_in_user_by_group_permission() {
    ProjectDto privateProject = db.components().insertPrivateProject().getProjectDto();
    ProjectDto Project = db.components().insertPublicProject().getProjectDto();
    UserDto user = db.users().insertUser();
    GroupDto group = db.users().insertGroup();
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_list_if_input_is_empty() {
    ProjectDto Project = db.components().insertPublicProject().getProjectDto();
    UserDto user = db.users().insertUser();
  ...
  @Test
  void keepAuthorizedEntityUuids_returns_empty_list_if_input_does_not_reference_existing_projects() {
    ProjectDto Project = db.components().insertPublicProject().getProjectDto();
    UserDto user = db.users().insertUser();
  ...
  @Test
  void keepAuthorizedEntityUuids_returns__projects_if_permission_USER_or_CODEVIEWER() {
    ProjectDto Project = db.components().insertPublicProject().getProjectDto();
    UserDto user = db.users().insertUser();
  ...
  @Test
  void selectQualityProfileAdministratorLogins_return_users_with_quality_profile_administrator_permission() {
  ...
  @Test
  void selectQualityProfileAdministratorLogins_return_users_within_quality_profile_administrator_group() {
  ...
  @Test
  void selectQualityProfileAdministratorLogins_does_not_return_non_quality_profile_administrator() {
    UserDto user1 = db.users().insertUser(withEmail("user1"));
  ...
  @Test
  void selectQualityProfileAdministratorLogins_does_not_return_quality_profile_administrator_without_email() {
  ...
  @Test
  void selectGlobalAdministerEmailSubscribers_returns_only_global_administers() {
    UserDto user1 = db.users().insertUser(withEmail("user1"));
    db.users().insertGlobalPermissionOnUser(user1, ADMINISTER);
  ...
  @Test
  void selectGlobalAdministerEmailSubscribers_ignores_global_administers_without_email() {
  ...
  @Test
  void keepAuthorizedLoginsOnEntity_return_correct_users_on__project() {
    ProjectDto project = db.components().insertPublicProject().getProjectDto();
  ...
  @Test
  void keepAuthorizedLoginsOnEntity_return_correct_users_on_private_project() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
  ...
  @Test
  void keepAuthorizedLoginsOnEntity_whenHasBranch_shouldReturnExpectedUsers() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
