...
public class UserDaoTest {
  ...
  public void insert_user() {
    ...
    assertThat(user.getHomepageKey()).isEqualTo("OB1");
  }
  ...
  public void update_user() {
    ...
    assertThat(reloaded.getHomepageKey()).isEqualTo("OB1");
  }
  ...
  public void deactivate_user() {
    ...
    assertThat(userReloaded.getHomepageKey()).isNull();
  ...
  public void select_by_login() {
    ...
    assertThat(dto.getHomepageKey()).isEqualTo("OB1");
