...
public class PurgeDaoTest {
  ...
  public void shouldDeleteAbortedBuilds() {
    ...
    underTest.purge(dbSession, newConfigurationWith30Days(), IGNORE_PURGE_EVENTS, new PurgeProfiler());
    dbSession.commit();
  ...
  public void shouldDeleteHistoricalDataOfDirectoriesAndFiles() {
    ...
    underTest.purge(dbSession, conf, IGNORE_PURGE_EVENTS, new PurgeProfiler());
    dbSession.commit();
  ...
  public void close_issues_clean_index_and_file_sources_of_disabled_components_specified_by_uuid_in_configuration() {
    ...
    underTest.purge(dbSession, newConfigurationWith30Days(system2, "P1", "EFGH", "GHIJ"), IGNORE_PURGE_EVENTS, new PurgeProfiler());
    dbSession.commit();
  ...
  PurgeListener IGNORE_PURGE_EVENTS = new PurgeListener() {
    @Override
