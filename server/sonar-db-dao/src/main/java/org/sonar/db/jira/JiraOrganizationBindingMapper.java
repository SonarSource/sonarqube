...
public interface JiraOrganizationBindingMapper {

  @CheckForNull
  JiraOrganizationBindingDto selectById(@Param("id") String id);

  @CheckForNull
  JiraOrganizationBindingDto selectBySonarOrganizationUuid(@Param("sonarOrganizationUuid") String sonarOrganizationUuid);

  void insert(@Param("dto") JiraOrganizationBindingDto dto);
