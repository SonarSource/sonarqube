...
import org.sonar.db.agent.AgentJobMapper;
...
public class DefaultMyBatis extends AbstractMyBatis {
  ...
  public DefaultMyBatis(Database database) {
    this(database, null);
  }

  @Autowired(required = false)
  public DefaultMyBatis(Database database, @Nullable BaseMyBatisConfExtension[] confExtensions) {
    super(database, confExtensions);
  }

  @Override
  public void configureBeforeMappersOnStart(MyBatisConfBuilder confBuilder) {
    ...
    confBuilder.loadAlias("IssueWithoutRuleInfo", IssueWithoutRuleInfoDto.class);
