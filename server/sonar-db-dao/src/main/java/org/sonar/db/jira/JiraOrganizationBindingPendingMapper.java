...
public interface JiraOrganizationBindingPendingMapper {

  @CheckForNull
  JiraOrganizationBindingPendingDto selectBySonarOrganizationUuid(@Param("sonarOrganizationUuid") String sonarOrganizationUuid);
