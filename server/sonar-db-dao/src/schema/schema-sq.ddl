...
ALTER TABLE "A3S_PURGE_TASKS" ADD CONSTRAINT "PK_A3S_PURGE_TASKS" PRIMARY KEY("TASK_NAME", "TASK_INSTANCE");
CREATE INDEX "IDX_A3S_PURGE_EXEC_TIME" ON "A3S_PURGE_TASKS"("EXECUTION_TIME" NULLS FIRST);
CREATE INDEX "IDX_A3S_PURGE_HEARTBEAT" ON "A3S_PURGE_TASKS"("LAST_HEARTBEAT" NULLS FIRST);
...
CREATE TABLE "AGENT_JOBS"(
    ...
    "REPOSITORY_URL" CHARACTER VARYING(2000) NOT NULL,
    ...
    "ERROR_KEY" CHARACTER VARYING(255),
...
ALTER TABLE "AGENT_JOBS" ADD CONSTRAINT "PK_AGENT_JOBS" PRIMARY KEY("ID");
CREATE INDEX "IDX_AGENT_JOBS_STATUS" ON "AGENT_JOBS"("STATUS" NULLS FIRST);
CREATE INDEX "IDX_AGENT_JOBS_PROJECT_STATUS" ON "AGENT_JOBS"("PROJECT_ID" NULLS FIRST, "STATUS" NULLS FIRST, "CREATED_AT" DESC NULLS LAST);

CREATE TABLE "AGENT_ORCH_TASKS"(
    "TASK_NAME" CHARACTER VARYING(255) NOT NULL,
    "TASK_INSTANCE" CHARACTER VARYING(40) NOT NULL,
    "TASK_DATA" BINARY LARGE OBJECT,
    "EXECUTION_TIME" TIMESTAMP NOT NULL,
    "PICKED" BOOLEAN NOT NULL,
    "PICKED_BY" CHARACTER VARYING(100),
...
ALTER TABLE "AGENT_ORCH_TASKS" ADD CONSTRAINT "PK_AGENT_ORCH_TASKS" PRIMARY KEY("TASK_NAME", "TASK_INSTANCE");
CREATE INDEX "IDX_AGENT_ORCH_EXEC_TIME" ON "AGENT_ORCH_TASKS"("EXECUTION_TIME" NULLS FIRST);
CREATE INDEX "IDX_AGENT_ORCH_HEARTBEAT" ON "AGENT_ORCH_TASKS"("LAST_HEARTBEAT" NULLS FIRST);
...
CREATE TABLE "AGENT_SCHEDULES"(
    ...
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "SELECTED_PROJECT_IDS" CHARACTER LARGE OBJECT
);
...
CREATE TABLE "ALM_PATS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "PAT" CHARACTER VARYING(4000) NOT NULL,
...
CREATE TABLE "ARCH_BOUNDARIES"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_ID" CHARACTER VARYING(40) NOT NULL,
    "BOUNDARY_KEY" CHARACTER VARYING(255) NOT NULL,
    "DIRECTION" CHARACTER VARYING(20) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL
);
ALTER TABLE "ARCH_BOUNDARIES" ADD CONSTRAINT "PK_ARCH_BOUNDARIES" PRIMARY KEY("ORGANIZATION_ID", "PROJECT_ID", "BRANCH_ID", "BOUNDARY_KEY", "DIRECTION");

CREATE TABLE "ARCH_BOUNDARY_DESCRIPTORS"(
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "ECOSYSTEM" CHARACTER VARYING(255) NOT NULL,
    "DIRECTION" CHARACTER VARYING(255) NOT NULL,
    "QUERY" CHARACTER LARGE OBJECT NOT NULL,
    "KEY_TEMPLATE" CHARACTER LARGE OBJECT NOT NULL,
    "CREATED_AT" BIGINT NOT NULL
);
ALTER TABLE "ARCH_BOUNDARY_DESCRIPTORS" ADD CONSTRAINT "PK_ARCH_BOUNDARY_DESCRIPTORS" PRIMARY KEY("PROJECT_ID", "UUID");
CREATE INDEX "ARCH_BOUNDARY_DESCRIPTORS_UUID" ON "ARCH_BOUNDARY_DESCRIPTORS"("UUID" NULLS FIRST);
...
CREATE TABLE "ARCH_MODEL_PATTERNS"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "MODEL_ID" CHARACTER VARYING(40) NOT NULL,
    "PATTERN_ID" CHARACTER VARYING(40) NOT NULL
);
ALTER TABLE "ARCH_MODEL_PATTERNS" ADD CONSTRAINT "PK_ARCH_MODEL_PATTERNS" PRIMARY KEY("ORGANIZATION_ID", "MODEL_ID", "PATTERN_ID");
CREATE INDEX "IDX_ARCH_MODEL_PATTERNS_PAT" ON "ARCH_MODEL_PATTERNS"("ORGANIZATION_ID" NULLS FIRST, "PATTERN_ID" NULLS FIRST);
...
ALTER TABLE "ARCH_MODELS" ADD CONSTRAINT "PK_ARCH_MODELS" PRIMARY KEY("PROJECT_ID", "UUID");
CREATE INDEX "ARCH_MODELS_UUID" ON "ARCH_MODELS"("UUID" NULLS FIRST);

CREATE TABLE "ARCH_ORG_PLACEHOLDERS"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "ARCH_ORG_PLACEHOLDERS" ADD CONSTRAINT "PK_ARCH_ORG_PLACEHOLDERS" PRIMARY KEY("ORGANIZATION_ID", "UUID");
CREATE INDEX "ARCH_ORG_PLACEHOLDERS_UUID" ON "ARCH_ORG_PLACEHOLDERS"("UUID" NULLS FIRST);

CREATE TABLE "ARCH_ORG_SDKS"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "TARGET_COMPONENT_ID" CHARACTER VARYING(40),
    "SDK_KEY" CHARACTER VARYING(255) NOT NULL,
    "BOUNDARY_DESCRIPTORS" CHARACTER LARGE OBJECT NOT NULL,
    "CREATED_AT" BIGINT NOT NULL
);
ALTER TABLE "ARCH_ORG_SDKS" ADD CONSTRAINT "PK_ARCH_ORG_SDKS" PRIMARY KEY("ORGANIZATION_ID", "UUID");
CREATE INDEX "ARCH_ORG_SDKS_UUID" ON "ARCH_ORG_SDKS"("UUID" NULLS FIRST);
CREATE INDEX "ARCH_ORG_SDKS_TARGET" ON "ARCH_ORG_SDKS"("TARGET_COMPONENT_ID" NULLS FIRST);

CREATE TABLE "ARCH_PATTERNS"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "DATA" CHARACTER LARGE OBJECT NOT NULL
);
ALTER TABLE "ARCH_PATTERNS" ADD CONSTRAINT "PK_ARCH_PATTERNS" PRIMARY KEY("ORGANIZATION_ID", "UUID");
CREATE INDEX "ARCH_PATTERNS_UUID" ON "ARCH_PATTERNS"("UUID" NULLS FIRST);

CREATE TABLE "ARCH_PROJ_ORG_COMPO"(
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "ORG_COMPONENT_UUID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL
);
ALTER TABLE "ARCH_PROJ_ORG_COMPO" ADD CONSTRAINT "PK_ARCH_PROJ_ORG_COMPO" PRIMARY KEY("PROJECT_ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_ARCH_PROJ_ORG_COMPO" ON "ARCH_PROJ_ORG_COMPO"("ORG_COMPONENT_UUID" NULLS FIRST);
CREATE INDEX "IDX_ARCH_PROJ_ORG_COMPO" ON "ARCH_PROJ_ORG_COMPO"("ORGANIZATION_ID" NULLS FIRST);

CREATE TABLE "ARCH_PROJ_RELATIONS"(
    "ORGANIZATION_ID" CHARACTER VARYING(40) NOT NULL,
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "BOUNDARY_KEY" CHARACTER VARYING(255),
    "TARGET_COMPONENT_ID" CHARACTER VARYING(40),
    "TARGET_ENTRY_POINT_KEY" CHARACTER VARYING(255),
    "ORIGIN" CHARACTER VARYING(20) DEFAULT 'MANUAL' NOT NULL
);
ALTER TABLE "ARCH_PROJ_RELATIONS" ADD CONSTRAINT "PK_ARCH_PROJ_RELATIONS" PRIMARY KEY("ORGANIZATION_ID", "UUID");
CREATE INDEX "ARCH_PROJ_RELATIONS_UUID" ON "ARCH_PROJ_RELATIONS"("UUID" NULLS FIRST);
CREATE INDEX "ARCH_PROJ_RELATIONS_TARGET" ON "ARCH_PROJ_RELATIONS"("TARGET_COMPONENT_ID" NULLS FIRST);
CREATE INDEX "ARCH_PROJ_RELATIONS_PROJECT" ON "ARCH_PROJ_RELATIONS"("ORGANIZATION_ID" NULLS FIRST, "PROJECT_ID" NULLS FIRST);
...
ALTER TABLE "CAG_PURGE_TASKS" ADD CONSTRAINT "PK_CAG_PURGE_TASKS" PRIMARY KEY("TASK_NAME", "TASK_INSTANCE");
CREATE INDEX "IDX_CAG_PURGE_EXEC_TIME" ON "CAG_PURGE_TASKS"("EXECUTION_TIME" NULLS FIRST);
CREATE INDEX "IDX_CAG_PURGE_HEARTBEAT" ON "CAG_PURGE_TASKS"("LAST_HEARTBEAT" NULLS FIRST);

CREATE TABLE "CAG_USAGE"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "PROJECT_UUID" CHARACTER VARYING(40) NOT NULL,
    "INVOCATION_UUID" CHARACTER VARYING(40) NOT NULL,
    "USER_UUID" CHARACTER VARYING(40)
);
ALTER TABLE "CAG_USAGE" ADD CONSTRAINT "PK_CAG_USAGE" PRIMARY KEY("UUID");
CREATE INDEX "IDX_CAG_USAGE_CREATED_PROJ" ON "CAG_USAGE"("CREATED_AT" NULLS FIRST, "PROJECT_UUID" NULLS FIRST);
...
CREATE INDEX "CE_ACTIVITY_ANALYSIS_UUID" ON "CE_ACTIVITY"("ANALYSIS_UUID" NULLS FIRST);
...
ALTER TABLE "COMPONENTS" ADD CONSTRAINT "PK_COMPONENTS" PRIMARY KEY("UUID");
...
CREATE TABLE "DASHBOARDS"(
    ...
    "LAYOUT_STATE" CHARACTER LARGE OBJECT NOT NULL,
    ...
    "UPDATE_BY_ID" CHARACTER VARYING(40) NOT NULL
);
ALTER TABLE "DASHBOARDS" ADD CONSTRAINT "PK_DASHBOARDS" PRIMARY KEY("ID");
CREATE INDEX "IDX_DASHBOARDS_NAME_RESOURCE" ON "DASHBOARDS"("NAME" NULLS FIRST, "RESOURCE_TYPE" NULLS FIRST, "RESOURCE_ID" NULLS FIRST);
...
CREATE TABLE "DEVOPS_PERMS_MAPPING"(
    ...
    "DEVOPS_PLATFORM" CHARACTER VARYING(40) NOT NULL
);
...
CREATE TABLE "DOP_PR_SNAPSHOTS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_UUID" CHARACTER VARYING(40) NOT NULL,
    "PULL_REQUEST_ID" CHARACTER VARYING(255) NOT NULL,
    "AI_AGENT_JOB_ID" CHARACTER VARYING(40),
    "WORKFLOW_ORIGIN" CHARACTER VARYING(30),
    "PR_STATE" CHARACTER VARYING(20) NOT NULL,
    "CHECK_RUNS_JSON" CHARACTER LARGE OBJECT,
    "REQUESTED_REVIEWERS_JSON" CHARACTER LARGE OBJECT,
    "TERMINAL" BOOLEAN NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL
);
ALTER TABLE "DOP_PR_SNAPSHOTS" ADD CONSTRAINT "PK_DOP_PR_SNAPSHOTS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_DOP_PR_SNAPSHOTS_PR" ON "DOP_PR_SNAPSHOTS"("PROJECT_UUID" NULLS FIRST, "PULL_REQUEST_ID" NULLS FIRST);
CREATE INDEX "IDX_DOP_PR_SNAP_TERM_UPD" ON "DOP_PR_SNAPSHOTS"("TERMINAL" NULLS FIRST, "UPDATED_AT" NULLS FIRST);
...
CREATE TABLE "FINDING_LOCATIONS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "FINDING_ID" CHARACTER VARYING(40) NOT NULL,
    ...
    "FLOW_DESCRIPTION" CHARACTER VARYING(4000),
    "FLOW_TYPE" CHARACTER VARYING(100)
);
ALTER TABLE "FINDING_LOCATIONS" ADD CONSTRAINT "PK_FINDING_LOCATIONS" PRIMARY KEY("ID");
CREATE INDEX "IDX_FINDING_LOC_FINDING_ID" ON "FINDING_LOCATIONS"("FINDING_ID" NULLS FIRST);
...
CREATE TABLE "FINDINGS"(
    ...
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_ID" CHARACTER VARYING(40) NOT NULL,
    "PLAYBOOK_ID" CHARACTER VARYING(40) NOT NULL,
    "PLAYBOOK_KEY" CHARACTER VARYING(100) NOT NULL,
    "RULE_ID" CHARACTER VARYING(255) NOT NULL,
    "EFFORT_MINUTES" INTEGER NOT NULL,
    "ISSUE_STATUS" CHARACTER VARYING(20) NOT NULL,
    "CONTEXT" CHARACTER LARGE OBJECT NOT NULL,
    "AGENT_CONTEXT" CHARACTER LARGE OBJECT,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "RULE_TITLE" CHARACTER LARGE OBJECT,
    "RULE_IMPACT_SEVERITY" CHARACTER VARYING(20),
    "RULE_WHY_IS_THIS_AN_ISSUE" CHARACTER LARGE OBJECT,
    "RULE_HOW_TO_FIX" CHARACTER LARGE OBJECT
);
ALTER TABLE "FINDINGS" ADD CONSTRAINT "PK_FINDINGS" PRIMARY KEY("ID");
CREATE INDEX "IDX_FINDINGS_ORG_PROJ_BRANCH" ON "FINDINGS"("ORG_ID" NULLS FIRST, "PROJECT_ID" NULLS FIRST, "BRANCH_ID" NULLS FIRST);
...
CREATE INDEX "GROUP_ROLES_ENT_ROLE_GRP" ON "GROUP_ROLES"("ENTITY_UUID" NULLS FIRST, "ROLE" NULLS FIRST, "GROUP_UUID" NULLS FIRST);
...
CREATE TABLE "HUNTER_AGENT_JOBS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "JOB_ID" CHARACTER VARYING(40) NOT NULL,
    "ANALYZED_COMMIT_SHA" CHARACTER VARYING(40),
    "ANALYZED_AT" BIGINT,
    "PREVIOUS_JOB_ID" CHARACTER VARYING(40),
    "PREVIOUS_JOB_COMMIT_SHA" CHARACTER VARYING(40)
);
ALTER TABLE "HUNTER_AGENT_JOBS" ADD CONSTRAINT "PK_HUNTER_AGENT_JOBS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_HUNTER_AGENT_JOBS_JOB_ID" ON "HUNTER_AGENT_JOBS"("JOB_ID" NULLS FIRST);

CREATE TABLE "HUNTER_AGENT_RUNS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "JOB_ID" CHARACTER VARYING(40) NOT NULL,
    "ORG_ID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_ID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "HUNTER_AGENT_RUNS" ADD CONSTRAINT "PK_HUNTER_AGENT_RUNS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_HUNTER_AGENT_RUNS_JOB_ID" ON "HUNTER_AGENT_RUNS"("JOB_ID" NULLS FIRST);
CREATE INDEX "IDX_HUNTER_RUNS_BR_ANALYZED" ON "HUNTER_AGENT_RUNS"("ORG_ID" NULLS FIRST, "PROJECT_ID" NULLS FIRST, "BRANCH_ID" NULLS FIRST, "ANALYZED_AT" DESC NULLS LAST);

CREATE TABLE "HUNTER_SCHEDULED_TASKS"(
    "TASK_NAME" CHARACTER VARYING(50) NOT NULL,
    "TASK_INSTANCE" CHARACTER VARYING(400) NOT NULL,
    "TASK_DATA" BINARY LARGE OBJECT,
    "EXECUTION_TIME" TIMESTAMP NOT NULL,
    "PICKED" BOOLEAN NOT NULL,
    "PICKED_BY" CHARACTER VARYING(100),
...
ALTER TABLE "HUNTER_SCHEDULED_TASKS" ADD CONSTRAINT "PK_HUNTER_SCHEDULED_TASKS" PRIMARY KEY("TASK_NAME", "TASK_INSTANCE");
CREATE INDEX "IDX_HUNTER_SCHED_EXEC_TIME" ON "HUNTER_SCHEDULED_TASKS"("EXECUTION_TIME" NULLS FIRST);
CREATE INDEX "IDX_HUNTER_SCHED_HEARTBEAT" ON "HUNTER_SCHEDULED_TASKS"("LAST_HEARTBEAT" NULLS FIRST);
...
CREATE TABLE "ISSUE_TTR_HISTORY"(
    "ENTITY_ID" CHARACTER VARYING(40) NOT NULL,
    "ENTITY_TYPE" CHARACTER VARYING(40) NOT NULL,
    "DIMENSION_ID" INTEGER NOT NULL,
    "RECORDED_AT_EPOCH" BIGINT NOT NULL,
    ...
    "TOTAL_MINUTES_TO_RESOLUTION_RECENT" BIGINT NOT NULL,
    "ISSUES_RESOLVED_RECENT" INTEGER NOT NULL
);
CREATE UNIQUE NULLS NOT DISTINCT INDEX "ISSUE_TTR_HISTORY_UQ_IDX" ON "ISSUE_TTR_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "DIMENSION_ID" NULLS FIRST, "RECORDED_AT_EPOCH" DESC NULLS LAST);
CREATE INDEX "ISS_TTR_HISTORY_ENT_TYPE_EPOCH" ON "ISSUE_TTR_HISTORY"("ENTITY_ID" NULLS FIRST, "ENTITY_TYPE" NULLS FIRST, "RECORDED_AT_EPOCH" NULLS FIRST);
...
CREATE TABLE "ISSUES"(
    ...
    "PRODUCER" TINYINT DEFAULT 1 NOT NULL,
    "DEFERRAL_DATE" BIGINT
);
...
CREATE INDEX "ISSUES_DEFERRAL_DATE" ON "ISSUES"("DEFERRAL_DATE" NULLS FIRST);
CREATE INDEX "ISSUES_HOTSPOT_MIGRATION" ON "ISSUES"("ISSUE_TYPE" NULLS FIRST, "PROJECT_UUID" NULLS FIRST, "KEE" NULLS FIRST, "RULE_UUID" NULLS FIRST);
CREATE INDEX "ISSUES_RULE_UUID_CTX_KEY" ON "ISSUES"("RULE_UUID" NULLS FIRST, "RULE_DESCRIPTION_CONTEXT_KEY" NULLS FIRST);
...
CREATE TABLE "LLM_PROVIDER_MAPPINGS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "AI_CAPABILITY" CHARACTER VARYING(40) NOT NULL,
    "LLM_PROVIDER_ID" CHARACTER VARYING(40) NOT NULL,
    "MODEL_IDENTIFIER" CHARACTER VARYING(255),
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "SECONDARY_MODEL_IDENTIFIER" CHARACTER VARYING(255)
);
ALTER TABLE "LLM_PROVIDER_MAPPINGS" ADD CONSTRAINT "PK_LLM_PROVIDER_MAPPINGS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_LLM_PROV_MAP_CAPABILITY" ON "LLM_PROVIDER_MAPPINGS"("AI_CAPABILITY" NULLS FIRST);
CREATE INDEX "IDX_LLM_PROV_MAP_PROVIDER" ON "LLM_PROVIDER_MAPPINGS"("LLM_PROVIDER_ID" NULLS FIRST);

CREATE TABLE "LLM_PROVIDERS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "PROVIDER" CHARACTER VARYING(40) NOT NULL,
    "LABEL" CHARACTER VARYING(255) NOT NULL,
    "CONNECTION_CONFIG" CHARACTER LARGE OBJECT NOT NULL,
    "ENCRYPTED_SECRET" CHARACTER LARGE OBJECT,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL
);
ALTER TABLE "LLM_PROVIDERS" ADD CONSTRAINT "PK_LLM_PROVIDERS" PRIMARY KEY("ID");
...
CREATE TABLE "MEASURE_HISTORY"(
    ...
    "ENTITY_TYPE" CHARACTER VARYING(40) NOT NULL,
    "RECORDED_AT_EPOCH" BIGINT NOT NULL,
    "TEXT_VALUE" CHARACTER LARGE OBJECT
);
...
CREATE TABLE "NOTIF_GROUP_SUBSCRIPTIONS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "GROUP_UUID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "NOTIF_GROUP_SUBSCRIPTIONS" ADD CONSTRAINT "PK_NOTIF_GROUP_SUBSCRIPTIONS" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "NOTIF_GRP_SUB_UNIQ" ON "NOTIF_GROUP_SUBSCRIPTIONS"("GROUP_UUID" NULLS FIRST, "NOTIFICATION_TYPE" NULLS FIRST, "CHANNEL_KEY" NULLS FIRST);
CREATE INDEX "NOTIF_GRP_SUB_TYPE" ON "NOTIF_GROUP_SUBSCRIPTIONS"("NOTIFICATION_TYPE" NULLS FIRST, "CHANNEL_KEY" NULLS FIRST);
...
CREATE TABLE "ORGANIZATION_CONFIGS"(
    ...
    "IS_BETA_ENROLLED" BOOLEAN DEFAULT FALSE NOT NULL
);
ALTER TABLE "ORGANIZATION_CONFIGS" ADD CONSTRAINT "PK_ORGANIZATION_CONFIGS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_ORG_CONFIGS_ORG_ID" ON "ORGANIZATION_CONFIGS"("ORGANIZATION_ID" NULLS FIRST);
...
CREATE TABLE "PERMISSION_TEMPLATES"(
    ...
    "NAME_UPPER" CHARACTER VARYING(200) GENERATED ALWAYS AS (UPPER("NAME"))
);
ALTER TABLE "PERMISSION_TEMPLATES" ADD CONSTRAINT "PK_PERMISSION_TEMPLATES" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UNIQ_PERM_TEMPLATES_NAME" ON "PERMISSION_TEMPLATES"("NAME_UPPER" NULLS FIRST);
...
CREATE TABLE "PROJECT_CONFIGS"(
    ...
    "PROJECT_LEGACY_ID" CHARACTER VARYING(40),
    "ORGANIZATION_LEGACY_ID" CHARACTER VARYING(40),
    "IS_SCHEDULING_ENABLED" BOOLEAN,
    "SCHEDULING_BRANCH_ID" CHARACTER VARYING(40),
    "SCHEDULING_TIMEZONE" CHARACTER VARYING(50)
);
ALTER TABLE "PROJECT_CONFIGS" ADD CONSTRAINT "PK_PROJECT_CONFIGS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_PROJECT_CONFIGS_PROJECT_ID" ON "PROJECT_CONFIGS"("PROJECT_ID" NULLS FIRST);
CREATE INDEX "IDX_PROJ_CONFIGS_ORG_ID" ON "PROJECT_CONFIGS"("ORGANIZATION_ID" NULLS FIRST);
...
CREATE TABLE "REMEDIATION_AGENT_JOBS"(
    "ID" CHARACTER VARYING(40) NOT NULL,
    "JOB_ID" CHARACTER VARYING(40) NOT NULL,
    "DEVOPS_PLATFORM" CHARACTER VARYING(30),
    "SOURCE_PR_KEY" CHARACTER VARYING(255),
    "RESULT_PR_KEY" CHARACTER VARYING(255),
    "RESULT_BRANCH" CHARACTER VARYING(255),
    "RESULT_COMMIT" CHARACTER VARYING(40),
    "ISSUE_KEYS" CHARACTER LARGE OBJECT,
    "DOP_USER_ID" CHARACTER VARYING(255),
    "ISSUES_SELECTION_STRATEGY" CHARACTER VARYING(40)
);
ALTER TABLE "REMEDIATION_AGENT_JOBS" ADD CONSTRAINT "PK_REMEDIATION_AGENT_JOBS" PRIMARY KEY("ID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UQ_REM_AGENT_JOBS_JOB_ID" ON "REMEDIATION_AGENT_JOBS"("JOB_ID" NULLS FIRST);

CREATE TABLE "REMEDIATION_SCHED_TASKS"(
    "TASK_NAME" CHARACTER VARYING(50) NOT NULL,
    "TASK_INSTANCE" CHARACTER VARYING(400) NOT NULL,
    "TASK_DATA" BINARY LARGE OBJECT,
    "EXECUTION_TIME" TIMESTAMP NOT NULL,
...
ALTER TABLE "REMEDIATION_SCHED_TASKS" ADD CONSTRAINT "PK_REMEDIATION_SCHED_TASKS" PRIMARY KEY("TASK_NAME", "TASK_INSTANCE");
CREATE INDEX "IDX_REM_SCHED_EXEC_TIME" ON "REMEDIATION_SCHED_TASKS"("EXECUTION_TIME" NULLS FIRST);
CREATE INDEX "IDX_REM_SCHED_HEARTBEAT" ON "REMEDIATION_SCHED_TASKS"("LAST_HEARTBEAT" NULLS FIRST);
...
CREATE INDEX "RULE_DESC_SECTIONS_RULE_CTX" ON "RULE_DESC_SECTIONS"("RULE_UUID" NULLS FIRST, "CONTEXT_KEY" NULLS FIRST);
...
CREATE TABLE "SCA_ANALYSES"(
    ...
    "TYPE" CHARACTER VARYING(40) DEFAULT 'PROJECT' NOT NULL
);
...
CREATE TABLE "SCA_CONTAINER_ANALYSES"(
    "ANALYSIS_UUID" CHARACTER VARYING(40) NOT NULL,
    "ORGANIZATION_UUID" CHARACTER VARYING(40) NOT NULL
);
ALTER TABLE "SCA_CONTAINER_ANALYSES" ADD CONSTRAINT "PK_SCA_CONTAINER_ANALYSES" PRIMARY KEY("ANALYSIS_UUID");
...
CREATE INDEX "SCA_DEPENDENCIES_UPDATED_AT" ON "SCA_DEPENDENCIES"("UPDATED_AT" NULLS FIRST);
...
CREATE INDEX "SCA_IR_CVE_LOC_UPDATED_AT" ON "SCA_IR_CVE_LOCATIONS"("UPDATED_AT" NULLS FIRST);
...
CREATE TABLE "SECURITY_ALERT_INSTANCES"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "SECURITY_ALERT_UUID" CHARACTER VARYING(40) NOT NULL,
    "ORGANIZATION_UUID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_UUID" CHARACTER VARYING(40) NOT NULL,
    "PROJECT_UUID" CHARACTER VARYING(40) NOT NULL,
...
ALTER TABLE "SECURITY_ALERT_INSTANCES" ADD CONSTRAINT "PK_SECURITY_ALERT_INSTANCES" PRIMARY KEY("UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "SECURITY_ALERT_INST_UNIQ" ON "SECURITY_ALERT_INSTANCES"("SECURITY_ALERT_UUID" NULLS FIRST, "ORGANIZATION_UUID" NULLS FIRST, "BRANCH_UUID" NULLS FIRST);
CREATE INDEX "SECURITY_ALERT_INST_BRANCH" ON "SECURITY_ALERT_INSTANCES"("BRANCH_UUID" NULLS FIRST);
CREATE INDEX "SECURITY_ALERT_INST_PROJECT" ON "SECURITY_ALERT_INSTANCES"("PROJECT_UUID" NULLS FIRST);

CREATE TABLE "SECURITY_ALERT_SCA_RISKS"(
    "SECURITY_ALERT_UUID" CHARACTER VARYING(40) NOT NULL,
    "SCA_ISSUE_UUID" CHARACTER VARYING(40) NOT NULL,
    "ISSUE_DESCRIPTION" CHARACTER VARYING(4000),
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL
);
ALTER TABLE "SECURITY_ALERT_SCA_RISKS" ADD CONSTRAINT "PK_SECURITY_ALERT_SCA_RISKS" PRIMARY KEY("SECURITY_ALERT_UUID");
CREATE UNIQUE NULLS NOT DISTINCT INDEX "SECURITY_ALERT_SCA_ISSUE_UNIQ" ON "SECURITY_ALERT_SCA_RISKS"("SCA_ISSUE_UUID" NULLS FIRST);
...
ALTER TABLE "SECURITY_ALERTS" ADD CONSTRAINT "PK_SECURITY_ALERTS" PRIMARY KEY("UUID");
...
CREATE TABLE "SNAPSHOTS"(
    ...
    "RELATIVE_PATH_FROM_SCM_ROOT" CHARACTER VARYING(2000)
);
...
CREATE TABLE "VORTEX_CAG_EVENTS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    ...
    "USER_UUID" CHARACTER VARYING(40),
    "INVOCATION_UUID" CHARACTER VARYING(40) NOT NULL,
    "CAG_INSTANCE_ID" CHARACTER VARYING(255) NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "PAYLOAD" CHARACTER LARGE OBJECT NOT NULL
);
ALTER TABLE "VORTEX_CAG_EVENTS" ADD CONSTRAINT "PK_VORTEX_CAG_EVENTS" PRIMARY KEY("UUID");
CREATE INDEX "IDX_VTX_CAG_PROJ_CREATED" ON "VORTEX_CAG_EVENTS"("PROJECT_UUID" NULLS FIRST, "CREATED_AT" NULLS FIRST);
CREATE INDEX "IDX_VTX_CAG_CREATED" ON "VORTEX_CAG_EVENTS"("CREATED_AT" NULLS FIRST);

CREATE TABLE "VORTEX_SQAA_EVENTS"(
    "UUID" CHARACTER VARYING(40) NOT NULL,
    "EVENT_VERSION" INTEGER NOT NULL,
    "SUCCESS" BOOLEAN NOT NULL,
    "PROJECT_UUID" CHARACTER VARYING(40) NOT NULL,
    "BRANCH_NAME" CHARACTER VARYING(255),
    "BRANCH_ID" CHARACTER VARYING(40),
    "ANALYSIS_UUID" CHARACTER VARYING(40) NOT NULL,
    "USER_UUID" CHARACTER VARYING(40),
    "CREATED_AT" BIGINT NOT NULL,
    "PAYLOAD" CHARACTER LARGE OBJECT NOT NULL
);
ALTER TABLE "VORTEX_SQAA_EVENTS" ADD CONSTRAINT "PK_VORTEX_SQAA_EVENTS" PRIMARY KEY("UUID");
CREATE INDEX "IDX_VTX_SQAA_PROJ_CREATED" ON "VORTEX_SQAA_EVENTS"("PROJECT_UUID" NULLS FIRST, "CREATED_AT" NULLS FIRST);
CREATE INDEX "IDX_VTX_SQAA_CREATED" ON "VORTEX_SQAA_EVENTS"("CREATED_AT" NULLS FIRST);
