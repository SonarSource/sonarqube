...
CREATE TABLE "ARCHITECTURE_MODELS"(
    ...
    "MODEL" CHARACTER LARGE OBJECT NOT NULL
);
ALTER TABLE "ARCHITECTURE_MODELS" ADD CONSTRAINT "PK_ARCHITECTURE_MODELS" PRIMARY KEY("PROJECT_ID", "UUID");
CREATE INDEX "ARCHITECTURE_MODELS_UUID" ON "ARCHITECTURE_MODELS"("UUID" NULLS FIRST);
