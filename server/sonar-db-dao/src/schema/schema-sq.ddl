...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "IDX_JIRA_PROJ_BINDINGS_UNIQUE" ON "JIRA_PROJECT_BINDINGS"("SONAR_PROJECT_ID" NULLS FIRST, "JIRA_ORGANIZATION_BINDING_ID" NULLS FIRST);
