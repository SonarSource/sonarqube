...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UNIQ_GROUP_ROLES" ON "GROUP_ROLES"("ORGANIZATION_UUID" NULLS FIRST, "GROUP_UUID" NULLS FIRST, "ENTITY_UUID" NULLS FIRST, "ROLE" NULLS FIRST);
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UNIQ_GROUPS_NAME" ON "GROUPS"("ORGANIZATION_UUID" NULLS FIRST, "NAME" NULLS FIRST);
...
CREATE TABLE "ISSUES"(
    ...
    "PRIORITIZED_RULE" BOOLEAN,
    "ISSUE_RESOLUTION_EXPIRES_AT" BIGINT,
    "CODEFIX_STATUS" CHARACTER VARYING(50)
);
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "UNIQ_ORG_QUALITY_GATES" ON "ORG_QUALITY_GATES"("ORGANIZATION_UUID" NULLS FIRST, "QUALITY_GATE_UUID" NULLS FIRST);
...
CREATE TABLE "ORGANIZATIONS"(
    ...
    "INVITE_USERS_ENABLED" BOOLEAN DEFAULT TRUE NOT NULL,
    "CREATED_AT" BIGINT NOT NULL,
    "UPDATED_AT" BIGINT NOT NULL,
    "IS_ARCHIVED" BOOLEAN,
    "ARCHIVED_AT" BIGINT
...
CREATE UNIQUE NULLS NOT DISTINCT INDEX "ORGANIZATION_KEY" ON "ORGANIZATIONS"("KEE" NULLS FIRST);
...
CREATE INDEX "IDX_RULE_TAGS" ON "RULE_TAGS"("VALUE" NULLS FIRST, "RULE_UUID" NULLS FIRST, "ORGANIZATION_UUID" NULLS FIRST);
