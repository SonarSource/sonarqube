...
CREATE TABLE "AGENTIC_JOB"(
    ...
    "STARTED_AT" BIGINT,
    "PULL_REQUEST_URL" CHARACTER VARYING(2000),
    "PULL_REQUEST_KEY" CHARACTER VARYING(255),
    "AGENT_BRANCH" CHARACTER VARYING(255),
    "HEAD_SHA" CHARACTER VARYING(40),
    "ISSUE_OUTCOMES" CHARACTER LARGE OBJECT,
    "FINISHED_AT" BIGINT
);
ALTER TABLE "AGENTIC_JOB" ADD CONSTRAINT "PK_AGENTIC_JOB" PRIMARY KEY("JOB_ID");
CREATE INDEX "AGENTIC_JOB_STATUS" ON "AGENTIC_JOB"("STATUS" NULLS FIRST);
CREATE INDEX "IDX_AGENTIC_JOB_PROJECT_STATUS" ON "AGENTIC_JOB"("PROJECT_KEY" NULLS FIRST, "STATUS" NULLS FIRST, "CREATED_AT" DESC NULLS LAST);
