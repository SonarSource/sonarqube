...
public class FeatureWsTest {

  private static final String CONTROLLER_FEATURES = "api/features";

  private final FeatureWs underTest = new FeatureWs(new ListAction(List.of()));
