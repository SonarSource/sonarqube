...
public class RulesWsParameters {
  ...
  public static final String PARAM_AI_CODE_FIX_ENABLED = "ai_code_fix_enabled";
  ...
  public static final String FIELD_AI_CODE_FIX_ENABLED = "aiCodeFixEnabled";
