...
/**
 * A wrapper of a {@link DbSession} instance which allows overriding {@link DbSession}'s
 * {@link DbSession#close() close} method by implementing {@link #doClose()}. Otherwise,
 * all other methods are simply delegated to the wrapped instance.
 */
