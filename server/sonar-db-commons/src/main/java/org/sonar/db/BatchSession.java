...
/**
 * A session that will automatically commit after every certain number of statements.
 * This avoids exceeding transaction size limits if inserting or updating a large number of
 * records.
 */
