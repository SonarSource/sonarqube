...
public class ComponentIndexSortByNameTest extends ComponentIndexTest {
  ...
  public void sort_by_name() throws Exception {
    ...
    assertSearch(query.setSort(BY_ASCENDING_NAME)).containsExactly(project3.uuid(), project1.uuid(), project2.uuid());
  }
  ...
  public void sort_by_name_then_by_key() throws Exception {
    ...
    assertSearch(query.setSort(BY_ASCENDING_NAME)).containsExactly(project2.uuid(), project3.uuid(), project1.uuid());
  }
