...
public class TagsActionTest {
  ...
  public void return_system_tag() throws Exception {
    RuleDefinitionDto r = dbTester.rules().insertRuleDefinition(setSystemTags("tag"));
  ...
  public void return_tag() throws Exception {
    RuleDefinitionDto r = dbTester.rules().insertRuleDefinition(setSystemTags());
    ruleIndexer.indexRuleDefinition(r.getKey());
    dbTester.rules().insertRuleMetadata(r, organization, setTags("tag"));
