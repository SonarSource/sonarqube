...
public class TagsActionTest {
  ...
  public void return_tags_from_rules() throws Exception {
    RuleDefinitionDto r = db.rules().insertRuleDefinition(setSystemTags("tag1"));
    ruleIndexer.indexRuleDefinition(r.getKey());
    db.rules().insertRuleMetadata(r, organization, setTags("tag2"));
    ruleIndexer.indexRuleExtension(organization, r.getKey());

    RuleDefinitionDto r2 = db.rules().insertRuleDefinition(setSystemTags("tag3"));
    ruleIndexer.indexRuleDefinition(r2.getKey());
    db.rules().insertRuleMetadata(r2, organization, setTags("tag4", "tag5"));
  ...
  public void return_tags_from_issue_and_rule_tags() throws Exception {
    ...
    RuleDefinitionDto r = db.rules().insertRuleDefinition(setSystemTags("tag6"));
    ruleIndexer.indexRuleDefinition(r.getKey());
    db.rules().insertRuleMetadata(r, organization, setTags("tag7"));
    ruleIndexer.indexRuleExtension(organization, r.getKey());
  ...
  public void test_example() throws Exception {
    ...
    RuleDefinitionDto r = db.rules().insertRuleDefinition(setSystemTags("cwe"));
    ruleIndexer.indexRuleDefinition(r.getKey());
    db.rules().insertRuleMetadata(r, organization, setTags("security"));
    ruleIndexer.indexRuleExtension(organization, r.getKey());
  ...
  private RuleDefinitionDto insertRuleWithoutTags() {
    return db.rules().insertRuleDefinition(setSystemTags());
  }
