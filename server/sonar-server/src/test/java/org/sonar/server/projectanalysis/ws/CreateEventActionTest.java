...
public class CreateEventActionTest {
  ...
  private WsActionTester ws = new WsActionTester(new CreateEventAction(dbClient, uuidFactory, system));
  ...
  public void json_example() {
    ...
    ws = new WsActionTester(new CreateEventAction(dbClient, uuidFactory, system));
  ...
  public void create_event_in_db() {
    ...
    assertThat(dbEvent.getCategory()).isEqualTo(VERSION.name());
