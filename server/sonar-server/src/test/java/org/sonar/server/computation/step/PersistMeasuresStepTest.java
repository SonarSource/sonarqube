...
public class PersistMeasuresStepTest extends BaseStepTest {
  ...
  private List<Map<String, Object>> selectSnapshots() {
    return dbTester
      .select(
        "SELECT snapshot_id as \"snapshotId\", component_uuid as \"componentUuid\", metric_id as \"metricId\", rule_id as \"ruleId\", characteristic_id as \"characteristicId\", person_id as \"developerId\", "
        +
