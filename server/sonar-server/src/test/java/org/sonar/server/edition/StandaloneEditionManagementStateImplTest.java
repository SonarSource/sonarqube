...
public class StandaloneEditionManagementStateImplTest {
  ...
  public void uninstall_fails_with_ISE_if_called_after_startAutomaticInstall() {
    ...
    expectedException.expect(IllegalStateException.class);
    expectedException.expectMessage("Can't move to UNINSTALL_IN_PROGRESS when status is AUTOMATIC_IN_PROGRESS (should be any of [UNINSTALL_IN_PROGRESS, NONE])");
  ...
  public void uninstall_fails_with_ISE_if_called_after_automaticInstallReady() {
    ...
    expectedException.expect(IllegalStateException.class);
    expectedException.expectMessage("Can't move to UNINSTALL_IN_PROGRESS when status is AUTOMATIC_READY (should be any of [UNINSTALL_IN_PROGRESS, NONE])");
  ...
  public void uninstall_fails_with_ISE_if_called_after_manualInstall() {
    ...
    expectedException.expect(IllegalStateException.class);
    expectedException.expectMessage("Can't move to UNINSTALL_IN_PROGRESS when status is MANUAL_IN_PROGRESS (should be any of [UNINSTALL_IN_PROGRESS, NONE])");
