...
public class ReportNewCoverageMeasuresStepTest {
  ...
  public void verify_measure_of_condition_not_computed_if_there_is_none() {
    ...
    scmInfoRepository.setScmInfo(FILE_1_REF,
      Changeset.newChangesetBuilder().setAuthor("john").build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2007-01-15").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2011-01-01").getTime()).build()
    );
  ...
  public void verify_no_measure_when_nothing_has_changed() {
    ...
    scmInfoRepository.setScmInfo(FILE_1_REF,
      Changeset.newChangesetBuilder().setAuthor("john").build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2008-08-02").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2008-08-02").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2008-08-02").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2008-08-02").getTime()).build()
    );
  ...
  public void no_measures_for_FILE_component_without_CoverageData() {
    ...
    scmInfoRepository.setScmInfo(FILE_1_REF,
      Changeset.newChangesetBuilder().setAuthor("john").build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2008-05-18").getTime()).build()
    );
  ...
  private void defineChangeSetsAndMeasures(int componentRef, MetricKeys metricKeys, MeasureValues line4, MeasureValues line6) {
    scmInfoRepository.setScmInfo(componentRef,
      ...
      Changeset.newChangesetBuilder().setDate(parseDate("2007-01-15").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2011-01-01").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2012-02-23").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2012-02-23").getTime()).build(),
      Changeset.newChangesetBuilder().setDate(parseDate("2012-02-23").getTime()).build()
    );
