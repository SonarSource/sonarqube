...
public class DeactivateActionTest {
  ...
  public void fail_to_deactivate_last_administrator_of_default_organization() throws Exception {
    ...
    expectedException.expect(BadRequestException.class);
    expectedException.expectMessage("User cannot be deactivated as being the last administrator");
  ...
  public void fail_to_deactivate_last_administrator_of_organization() throws Exception {
    ...
    expectedException.expect(BadRequestException.class);
    expectedException.expectMessage("User cannot be deactivated as being the last administrator of organizations [org1, org2]");
