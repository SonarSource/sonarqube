...
public class ListActionTest {
  ...
  public void return_rules_in_protobuf() throws Exception {
    dbTester.rules().insertRule(RuleTesting.newRule(RuleKey.of("java", "S001")).setConfigKey(null).setName(null));
    dbTester.rules().insertRule(RuleTesting.newRule(RuleKey.of("java", "S002")).setConfigKey("I002").setName("Rule Two"));
