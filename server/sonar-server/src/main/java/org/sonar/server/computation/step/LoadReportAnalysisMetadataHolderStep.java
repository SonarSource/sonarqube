...
public class LoadReportAnalysisMetadataHolderStep implements ComputationStep {
  ...
  public void execute() {
    ...
    mutableAnalysisMetadataHolder.setIsCrossProjectDuplicationEnabled(reportMetadata.hasCrossProjectDuplicationActivated() && reportMetadata.getCrossProjectDuplicationActivated());
  }
