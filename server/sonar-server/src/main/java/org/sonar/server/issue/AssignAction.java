...
public class AssignAction extends Action {
  ...
  public boolean execute(Map<String, Object> properties, Context context) {
    ...
    return isAssigneeMemberOfIssueOrganization(assignee, properties, context) && issueUpdater.assign(context.issue(), assignee, context.issueChangeContext());
  }
  ...
  private static boolean isAssigneeMemberOfIssueOrganization(@Nullable UserDto assignee, Map<String, Object> properties, Context context) {
    return assignee == null || ((Set<String>) properties.get(ASSIGNEE_ORGANIZATIONS)).contains(context.issueOrganizationUuid());
  }
}
