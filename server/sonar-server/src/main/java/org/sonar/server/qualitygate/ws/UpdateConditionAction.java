...
public class UpdateConditionAction implements QualityGatesWsAction {
  ...
  public void handle(Request request, Response response) {
    ...
    try (DbSession dbSession = dbClient.openSession(false)) {
      ...
      setNullable(updatedCondition.getWarningThreshold(), updateConditionWsResponse::setWarning);
      setNullable(updatedCondition.getErrorThreshold(), updateConditionWsResponse::setError);
      setNullable(updatedCondition.getPeriod(), updateConditionWsResponse::setPeriod);
