...
public class ProjectStatusAction implements QGateWsAction {
  ...
  public void define(WebService.NewController controller) {
    WebService.NewAction action = controller.createAction("project_status")
      .setDescription(String.format("Quality gate status for a given project or Compute Engine task. <br />" +
  ...
  private ProjectAndSnapshot getProjectAndSnapshot(DbSession dbSession, ProjectStatusWsRequest request) {
    ...
    throw new BadRequestException("One of '%s', '%s', '%s' parameters must be provided", PARAM_ANALYSIS_ID, PARAM_PROJECT_ID, PARAM_PROJECT_KEY);
  }
  ...
  private static ProjectStatusWsRequest toProjectStatusWsRequest(Request request) {
    ...
    checkRequest(
      ...
      "One of '%s', '%s', '%s' parameters must be provided", PARAM_ANALYSIS_ID, PARAM_PROJECT_ID, PARAM_PROJECT_KEY);
