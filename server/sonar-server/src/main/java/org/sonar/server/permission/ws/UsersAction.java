...
import static org.sonar.server.permission.ws.PermissionWsCommons.isProjectUuidOrProjectKeyProvided;
...
public class UsersAction implements PermissionsWsAction {
  ...
  public UsersAction(DbClient dbClient, UserSession userSession, PermissionFinder permissionFinder, ComponentFinder componentFinder) {
  ...
  public void handle(Request wsRequest, Response wsResponse) throws Exception {
    ...
    Optional<ComponentDto> project = searchProject(wsRequest);
  ...
  private Optional<ComponentDto> searchProject(Request request) {
  ...
  private void checkPermissions(Optional<ComponentDto> project) {
  ...
  private boolean projectPresentAndAdminPermissionsOnIt(Optional<ComponentDto> project) {
