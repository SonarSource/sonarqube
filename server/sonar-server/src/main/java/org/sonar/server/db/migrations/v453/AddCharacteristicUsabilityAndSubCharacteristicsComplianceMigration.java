...
public class AddCharacteristicUsabilityAndSubCharacteristicsComplianceMigration extends BaseDataChange {
  ...
  public void execute(Context context) throws SQLException {
    ...
    createSubCharacteristic(characteristicsContext, "REUSABILITY_COMPLIANCE", "Reusability " + COMPLIANCE_NAME, "REUSABILITY");
    createSubCharacteristic(characteristicsContext, "PORTABILITY_COMPLIANCE", "Portability " + COMPLIANCE_NAME, "PORTABILITY");
    createSubCharacteristic(characteristicsContext, "MAINTAINABILITY_COMPLIANCE", "Maintainability " + COMPLIANCE_NAME, "MAINTAINABILITY");
    createSubCharacteristic(characteristicsContext, "SECURITY_COMPLIANCE", "Security " + COMPLIANCE_NAME, "SECURITY");
    createSubCharacteristic(characteristicsContext, "EFFICIENCY_COMPLIANCE", "Efficiency " + COMPLIANCE_NAME, "EFFICIENCY");
    createSubCharacteristic(characteristicsContext, "CHANGEABILITY_COMPLIANCE", "Changeability " + COMPLIANCE_NAME, "CHANGEABILITY");
    createSubCharacteristic(characteristicsContext, "RELIABILITY_COMPLIANCE", "Reliability " + COMPLIANCE_NAME, "RELIABILITY");
    createSubCharacteristic(characteristicsContext, "TESTABILITY_COMPLIANCE", "Testability " + COMPLIANCE_NAME, "TESTABILITY");
  }
  ...
  private void createOrUpdateUsabilityCharacteristicAndItsSubCharacteristic(CharacteristicsContext characteristicsContext, int newUsabilityOrder)
    ...
    createSubCharacteristic(characteristicsContext, "USABILITY_COMPLIANCE", "Usability " + COMPLIANCE_NAME, usabilityKey);
  }
