...
public class TelemetryCustomProjectDashboardCountProvider extends AbstractTelemetryDataProvider<Integer> {

  public static final String METRIC_KEY = "number_of_custom_project_dashboards";

  private final DashboardCountService dashboardCountService;

  protected TelemetryCustomProjectDashboardCountProvider(DashboardCountService dashboardCountService) {
  ...
  public Optional<Integer> getValue() {
    return Optional.of(dashboardCountService.count(DashboardResourceType.PROJECT));
  }
}
