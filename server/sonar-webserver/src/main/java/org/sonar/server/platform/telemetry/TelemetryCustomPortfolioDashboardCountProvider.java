...
public class TelemetryCustomPortfolioDashboardCountProvider extends AbstractTelemetryDataProvider<Integer> {

  public static final String METRIC_KEY = "number_of_custom_portfolio_dashboards";

  private final DashboardCountService dashboardCountService;

  protected TelemetryCustomPortfolioDashboardCountProvider(DashboardCountService dashboardCountService) {
  ...
  public Optional<Integer> getValue() {
    return Optional.of(dashboardCountService.count(DashboardResourceType.PORTFOLIO));
  }
}
