...
class AddNewInPullRequestToScaDependenciesTableIT {
  private static final String TABLE_NAME = "sca_dependencies";
  private static final String COLUMN_NAME = "new_in_pull_request";

  @RegisterExtension
  public final MigrationDbTester db = createForMigrationStep(AddNewInPullRequestToScaDependenciesTable.class);
  private final DdlChange underTest = new AddNewInPullRequestToScaDependenciesTable(db.database());
