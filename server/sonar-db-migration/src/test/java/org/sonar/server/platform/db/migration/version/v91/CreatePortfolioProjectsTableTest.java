...
public class CreatePortfolioProjectsTableTest {
  ...
  private final CreatePortfolioProjectsTable underTest = new CreatePortfolioProjectsTable(db.database());
  ...
  public void migration_should_be_reentrant() throws SQLException {
    ...
    db.assertTableExists(TABLE_NAME);
    db.assertPrimaryKey(TABLE_NAME, "pk_portfolio_projects", "uuid");
  }
}
