...
public class RestoreSonarUsersGroupsTest {
  ...
  public void display_log_when_creating_sonar_users_group() throws SQLException {
    ...
    checkSonarUsersHasBeenCreated();
    assertThat(logTester.logs(WARN)).containsOnly("The default group has been updated from '%s' to '%s'. Please verify your permission schema that everything is in order");
  }
