...
public class PopulateFileSourcesUuidTest {

  @Rule
  public CoreDbTester db = CoreDbTester.createForSchema(PopulateFileSourcesUuidTest.class, "schema.sql");

  private UuidFactory uuidFactory = UuidFactoryFast.getInstance();
  private DataChange underTest = new PopulateFileSourcesUuid(db.database(), uuidFactory);
  ...
  private void verifyUuidsAreNotNull() {
    assertThat(db.select("select uuid from file_sources")
      .stream()
