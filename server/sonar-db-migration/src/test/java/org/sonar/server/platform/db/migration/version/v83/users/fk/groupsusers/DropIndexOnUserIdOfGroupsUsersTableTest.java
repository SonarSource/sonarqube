...
public class DropIndexOnUserIdOfGroupsUsersTableTest {

  private static final String TABLE_NAME = "users_groups";
  private static final String INDEX_NAME = "index_groups_users_on_user_id";

  @Rule
  public CoreDbTester dbTester = CoreDbTester.createForSchema(DropIndexOnUserIdOfGroupsUsersTableTest.class, "schema.sql");

  DdlChange underTest = new DropIndexOnUserIdOfGroupsUsersTable(dbTester.database());
