...
public class PopulatePermTemplatesGroupsGroupUuidTest {
  private static final String TABLE_NAME = "perm_templates_groups";

  @Rule
  public CoreDbTester db = CoreDbTester.createForSchema(PopulatePermTemplatesGroupsGroupUuidTest.class, "schema.sql");

  private DataChange underTest = new PopulatePermTemplatesGroupsGroupUuid(db.database());
  ...
  public void populate_uuids() throws SQLException {
    ...
    insertPermTemplatesGroup(4L, 1L);
    insertPermTemplatesGroup(5L, 2L);
    insertPermTemplatesGroup(6L, 3L);
  ...
  public void delete_orphan_rows() throws SQLException {
    ...
    insertPermTemplatesGroup(4L, 1L);
    insertPermTemplatesGroup(5L, 2L);
    insertPermTemplatesGroup(6L, 10L);
    insertPermTemplatesGroup(7L, null);
  ...
  private void insertPermTemplatesGroup(Long id, Long groupId) {
