...
public class CreateTableQProfileEditGroupsTest {
  ...
  public void creates_table_on_empty_db() throws SQLException {
    ...
    db.assertColumnDefinition(TABLE, "group_id", Types.INTEGER, null, false);
    ...
    db.assertIndex(TABLE, "qprofile_edit_groups_qprofile", "qprofile_uuid");
    db.assertUniqueIndex(TABLE, "qprofile_edit_groups_unique", "group_id", "qprofile_uuid");
  }
