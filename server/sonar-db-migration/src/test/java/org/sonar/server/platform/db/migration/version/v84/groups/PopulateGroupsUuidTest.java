...
public class PopulateGroupsUuidTest {

  @Rule
  public CoreDbTester db = CoreDbTester.createForSchema(PopulateGroupsUuidTest.class, "schema.sql");

  private UuidFactory uuidFactory = UuidFactoryFast.getInstance();
  private DataChange underTest = new PopulateGroupsUuid(db.database(), uuidFactory);
  ...
  private void verifyUuidsAreNotNull() {
    assertThat(db.select("select uuid from groups")
      .stream()
