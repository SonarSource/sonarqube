...
public class PopulatePermTemplatesUsersUuidTest {

  @Rule
  public CoreDbTester db = CoreDbTester.createForSchema(PopulatePermTemplatesUsersUuidTest.class, "schema.sql");

  private UuidFactory uuidFactory = UuidFactoryFast.getInstance();
  private DataChange underTest = new PopulatePermTemplatesUsersUuid(db.database(), uuidFactory);
  ...
  private void verifyUuidsAreNotNull() {
    assertThat(db.select("select uuid from perm_templates_users")
      .stream()
