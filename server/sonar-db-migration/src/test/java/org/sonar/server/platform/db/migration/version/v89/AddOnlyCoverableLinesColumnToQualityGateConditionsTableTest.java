...
public class AddOnlyCoverableLinesColumnToQualityGateConditionsTableTest {
  ...
  public final CoreDbTester dbTester = CoreDbTester.createForSchema(
    AddOnlyCoverableLinesColumnToQualityGateConditionsTableTest.class, "schema.sql");
  private final AddOnlyCoverableLinesColumnToQualityGateConditionsTable underTest = new AddOnlyCoverableLinesColumnToQualityGateConditionsTable(dbTester.database());

  @Test
  public void column_has_been_made_non_nullable() throws SQLException {
    dbTester.assertColumnDoesNotExist(TABLE_NAME, COLUMN_NAME_ONLY_COVERABLE_LINES);
    underTest.execute();
