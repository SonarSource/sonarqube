...
public class SmallIntColumnDefTest {
  @Test
  public void build_small_int_column_def() {
    SmallIntColumnDef def = new SmallIntColumnDef.Builder()
      .setColumnName("foo")
      .setIsNullable(true)
      .build();
  ...
  public void generate_sql_type() {
    ...
    assertThat(def.generateSqlType(new H2())).isEqualTo("SMALLINT");
    assertThat(def.generateSqlType(new PostgreSql())).isEqualTo("SMALLINT");
    assertThat(def.generateSqlType(new MsSql())).isEqualTo("SMALLINT");
    assertThat(def.generateSqlType(new Oracle())).isEqualTo("NUMBER(5)");
  }
  ...
  public void fail_with_UOE_to_generate_sql_type_when_unknown_dialect() {
    ...
    assertThatThrownBy(() -> def.generateSqlType(dialect))
