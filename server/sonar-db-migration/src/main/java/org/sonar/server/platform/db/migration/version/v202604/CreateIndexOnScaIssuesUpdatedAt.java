...
public class CreateIndexOnScaIssuesUpdatedAt extends DdlChange {

  static final String TABLE_NAME = "sca_issues";
  static final String INDEX_NAME = "sca_issues_updated_at";
  static final String COLUMN_NAME = "updated_at";

  public CreateIndexOnScaIssuesUpdatedAt(Database db) {
    super(db);
  }
