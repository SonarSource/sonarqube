...
public class CreateUserBindingsTable extends CreateTableChange {

  static final String USER_BINDINGS_TABLE_NAME = "user_bindings";
  ...
  protected CreateUserBindingsTable(Database db) {
    super(db, USER_BINDINGS_TABLE_NAME);
  }
  ...
  public void execute(Context context, String tableName) throws SQLException {
    ...
    context.execute(new CreateIndexBuilder(dialect)
      .setTable(tableName)
      .setName("ub_user_integration_config")
      .addColumn(COLUMN_USER_UUID, false)
