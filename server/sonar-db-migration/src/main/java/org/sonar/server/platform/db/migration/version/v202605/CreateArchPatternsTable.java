...
public class CreateArchPatternsTable extends CreateTableChange {

  static final String TABLE_NAME = "arch_patterns";
  static final String COLUMN_ORGANIZATION_ID = "organization_id";
  static final String COLUMN_UUID = "uuid";
  static final String COLUMN_NAME = "name";
  static final String COLUMN_DATA = "data";
  static final String INDEX_UUID = "arch_patterns_uuid";

  static final int NAME_SIZE = 255;

  protected CreateArchPatternsTable(Database db) {
    super(db, TABLE_NAME);
  }
  ...
  public void execute(Context context, String tableName) throws SQLException {
    context.execute(new DynamoStyleTableBuilder(getDialect(), tableName)
      ...
      .withAttribute(newVarcharColumnDefBuilder().setColumnName(COLUMN_NAME).setLimit(NAME_SIZE).setIsNullable(false).build())
