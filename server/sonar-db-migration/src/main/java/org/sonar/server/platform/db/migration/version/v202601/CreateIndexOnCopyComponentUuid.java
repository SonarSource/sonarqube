...
public class CreateIndexOnCopyComponentUuid extends DdlChange {

  static final String TABLE_NAME = "components";
  // abbreviated for 30 char limit
  static final String INDEX_NAME = "components_copy_component";
  static final String COLUMN_NAME = "copy_component_uuid";

  public CreateIndexOnCopyComponentUuid(Database db) {
    super(db);
  }
