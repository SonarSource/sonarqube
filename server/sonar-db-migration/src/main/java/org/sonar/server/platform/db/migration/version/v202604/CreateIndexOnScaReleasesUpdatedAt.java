...
public class CreateIndexOnScaReleasesUpdatedAt extends DdlChange {

  static final String TABLE_NAME = "sca_releases";
  static final String INDEX_NAME = "sca_releases_updated_at";
  static final String COLUMN_NAME = "updated_at";

  public CreateIndexOnScaReleasesUpdatedAt(Database db) {
    super(db);
  }
