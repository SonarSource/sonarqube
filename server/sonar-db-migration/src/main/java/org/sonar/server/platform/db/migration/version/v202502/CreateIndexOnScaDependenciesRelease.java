...
public class CreateIndexOnScaDependenciesRelease extends DdlChange {

  static final String TABLE_NAME = "sca_dependencies";
  static final String INDEX_NAME = "sca_dependencies_release_uuid";
  static final String COLUMN_NAME_SCA_RELEASE_UUID = "sca_release_uuid";

  public CreateIndexOnScaDependenciesRelease(Database db) {
    super(db);
  }
