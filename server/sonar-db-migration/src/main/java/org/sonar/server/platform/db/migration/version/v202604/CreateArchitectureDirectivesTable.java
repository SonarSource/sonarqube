...
public class CreateArchitectureDirectivesTable extends CreateTableChange {

  static final String TABLE_NAME = "arch_directives";
  static final String COLUMN_PROJECT_ID = "project_id";
  static final String COLUMN_UUID = "uuid";
  static final String COLUMN_DATA = "data";
  static final String COLUMN_CREATED_AT = "created_at";
  static final String INDEX_UUID = "arch_directives_uuid";

  protected CreateArchitectureDirectivesTable(Database db) {
    super(db, TABLE_NAME);
  }
