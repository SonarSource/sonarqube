...
public class CreateIndexOnScaIssuesReleasesUpdatedAt extends DdlChange {

  static final String TABLE_NAME = "sca_issues_releases";
  static final String INDEX_NAME = "sca_issues_releases_updated_at";
  static final String COLUMN_NAME = "updated_at";

  public CreateIndexOnScaIssuesReleasesUpdatedAt(Database db) {
    super(db);
  }
