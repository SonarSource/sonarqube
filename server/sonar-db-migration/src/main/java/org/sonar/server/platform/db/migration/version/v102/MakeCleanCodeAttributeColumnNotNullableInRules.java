...
public class MakeCleanCodeAttributeColumnNotNullableInRules extends DdlChange {
  ...
  public MakeCleanCodeAttributeColumnNotNullableInRules(Database db) {
    super(db);
  }

  @Override
  public void execute(Context context) throws SQLException {
    VarcharColumnDef columnDef = VarcharColumnDef.newVarcharColumnDefBuilder(COLUMN_NAME)
