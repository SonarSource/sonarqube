...
public class MakeRootColumnNotNullOnTableUsers extends DdlChange {
  ...
  public void execute(Context context) throws SQLException {
    context.execute(new AlterColumnsBuilder(getDatabase().getDialect(), "users")
      .updateColumn(newBooleanColumnDefBuilder().setColumnName("is_root").setIsNullable(false).build())
      .build());
  }
}
