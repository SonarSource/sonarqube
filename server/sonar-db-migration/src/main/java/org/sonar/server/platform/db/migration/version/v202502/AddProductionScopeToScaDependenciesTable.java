...
public class AddProductionScopeToScaDependenciesTable extends DdlChange {
  static final String TABLE_NAME = "sca_dependencies";
  static final String COLUMN_NAME = "production_scope";

  public AddProductionScopeToScaDependenciesTable(Database db) {
    super(db);
  }
