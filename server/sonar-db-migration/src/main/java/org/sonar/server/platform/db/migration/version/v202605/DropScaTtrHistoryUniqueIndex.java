 ...
 */
public class DropScaTtrHistoryUniqueIndex extends DropIndexChange {
  static final String TABLE_NAME = "sca_ttr_history";
  static final String INDEX_NAME = "sca_ttr_history_uq_idx";

  public DropScaTtrHistoryUniqueIndex(Database db) {
