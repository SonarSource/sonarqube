...
public class AddQuickFixAvailableColumnInIssuesTable extends DdlChange {

  private static final String TABLE_NAME = "issues";
  private static final String COLUMN_NAME = "quick_fix_available";
  ...
  public AddQuickFixAvailableColumnInIssuesTable(Database db) {
    super(db);
  }
