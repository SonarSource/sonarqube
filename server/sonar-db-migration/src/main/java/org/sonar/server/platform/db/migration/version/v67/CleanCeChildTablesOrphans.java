...
public class CleanCeChildTablesOrphans extends DataChange {
  ...
  private void deleteOrphansInCeChildTable(Context context, String childTableName) throws SQLException {
    ...
    massUpdate.execute(this::deleteByTaskUuid);
  }

  private boolean deleteByTaskUuid(Select.Row row, SqlStatement update) throws SQLException {
