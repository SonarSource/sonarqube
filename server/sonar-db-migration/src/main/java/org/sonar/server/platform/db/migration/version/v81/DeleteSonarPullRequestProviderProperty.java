...
public class DeleteSonarPullRequestProviderProperty extends DataChange {

  public DeleteSonarPullRequestProviderProperty(Database db) {
    super(db);
  }
  ...
  protected void execute(Context context) throws SQLException {
    ...
    massUpdate.select("select id from properties where prop_key = ?")
      .setString(1, "sonar.pullrequest.provider");
