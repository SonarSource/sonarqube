...
public class CreateArchitectureModelsTable extends CreateTableChange {

  static final String TABLE_NAME = "architecture_models";
  ...
  static final String INDEX_UUID = "architecture_models_uuid";

  protected CreateArchitectureModelsTable(Database db) {
    super(db, TABLE_NAME);
  }
  ...
  public void execute(Context context, String tableName) throws SQLException {
    context.execute(new DynamoStyleTableBuilder(getDialect(), tableName)
      ...
      .withAttribute(newClobColumnDefBuilder().setColumnName(COLUMN_MODEL).setIsNullable(false).build())
