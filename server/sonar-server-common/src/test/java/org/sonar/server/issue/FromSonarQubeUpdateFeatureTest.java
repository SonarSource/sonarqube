...
class FromSonarQubeUpdateFeatureTest {
  SonarRuntime sonarRuntime = mock();
  private final FromSonarQubeUpdateFeature underTest = new FromSonarQubeUpdateFeature(sonarRuntime);

  @Test
  void isAvailable_shouldOnlyBeEnabledInDeveloperEditionPlus() {
    testForEdition(SonarEdition.COMMUNITY, false);
    testForEdition(SonarEdition.DEVELOPER, true);
