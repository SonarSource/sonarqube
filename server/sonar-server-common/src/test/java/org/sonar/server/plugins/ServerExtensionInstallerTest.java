...
public class ServerExtensionInstallerTest {
  ...
  public void fail_when_detecting_github_auth_plugin() {
    ...
    expectedException.expectMessage("Plugins 'GitHub Auth' are no longer compatible with SonarQube");
  ...
  public void fail_when_detecting_auth_plugins() {
    ...
    expectedException.expect(MessageException.class);
    expectedException.expectMessage("Plugins 'GitLab Auth, LDAP, SAML Auth' are no longer compatible with SonarQube");
  ...
  public void fail_when_detecting_saml_auth_plugin() {
    ...
    expectedException.expect(MessageException.class);
    expectedException.expectMessage("Plugins 'SAML Auth' are no longer compatible with SonarQube");
  ...
  public void fail_when_detecting_ldap_auth_plugin() {
    ...
    expectedException.expect(MessageException.class);
    expectedException.expectMessage("Plugins 'LDAP' are no longer compatible with SonarQube");
