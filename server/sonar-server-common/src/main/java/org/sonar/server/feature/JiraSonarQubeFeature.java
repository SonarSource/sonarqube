...
@ServerSide
public class JiraSonarQubeFeature implements SonarQubeFeature {

  private final SonarRuntime sonarRuntime;

  public JiraSonarQubeFeature(SonarRuntime sonarRuntime) {
  ...
  public boolean isAvailable() {
    return sonarRuntime.getEdition() == DEVELOPER
      || sonarRuntime.getEdition() == ENTERPRISE
