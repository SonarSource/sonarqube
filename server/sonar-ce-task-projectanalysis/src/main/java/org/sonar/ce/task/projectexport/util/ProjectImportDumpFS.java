...
public interface ProjectImportDumpFS {
  /**
   * Create a File representing the archive dump of the specified {@link ProjectDescriptor} to be imported.
   * <p>
   * This method doesn't check nor enforce the File actually exist and/or is a regular file.
   * </p>
   */
  File importDumpOf(ProjectDescriptor descriptor);
