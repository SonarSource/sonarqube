...
public class SonarLintPushEventEventExecutorServiceImpl extends
  AbstractStoppableScheduledExecutorServiceImpl<ScheduledExecutorService> implements SonarLintPushEventExecutorService {

  public SonarLintPushEventEventExecutorServiceImpl() {
    super(newSingleThreadScheduledExecutor(SonarLintPushEventEventExecutorServiceImpl::createThread));
  }
