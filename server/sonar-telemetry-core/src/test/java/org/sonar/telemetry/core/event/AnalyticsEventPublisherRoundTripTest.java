...
class AnalyticsEventPublisherRoundTripTest {
  ...
  void publish_whenDispatchedInComputeEngine_routesSerializedPayloadToGessieHandler() {
    ...
    var payload = new IssueBacklogTelemetryEvent(
      "project-uuid", "branch-uuid", "BRANCH", "merge-branch-uuid", 1_700_000_000_000L, List.of(new RuleCounts("java:S1234", 3, 0, 0, 0, 0)));
    ...
    assertThat(payloadJson.get("merge_branch_uuid").asText()).isEqualTo("merge-branch-uuid");
