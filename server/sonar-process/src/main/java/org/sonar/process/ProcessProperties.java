...
public class ProcessProperties {
  ...
  public enum Property {
    ...
    JDBC_USE_AWS_MANAGED_IDENTITY("sonar.jdbc.aws.identity", ""),
    JDBC_AWS_REGION("sonar.jdbc.aws.region", ""),
    JDBC_AWS_HOSTNAME("sonar.jdbc.aws.hostname", ""),
    JDBC_AWS_PORT("sonar.jdbc.aws.port", ""),
