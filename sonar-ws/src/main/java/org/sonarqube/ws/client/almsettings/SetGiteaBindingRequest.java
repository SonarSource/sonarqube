...
public class SetGiteaBindingRequest {
   ...
   */
  public SetGiteaBindingRequest setAlmSetting(String almSetting) {
   ...
   * This is a mandatory parameter.
   */
  public SetGiteaBindingRequest setProject(String project) {
   ...
   * This is a mandatory parameter.
   */
  public SetGiteaBindingRequest setRepository(String repository) {
