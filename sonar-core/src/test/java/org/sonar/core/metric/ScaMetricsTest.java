...
class ScaMetricsTest {
  ...
  static Stream<Arguments> scaMetricKeyProvider() {
    return Stream.of(
      ...
      Arguments.of(ScaMetrics.NEW_SCA_RATING_ANY_SECURITY_KEY, "new_sca_rating_any_security"),
      ...
      Arguments.of(ScaMetrics.NEW_SCA_SEVERITY_ANY_SECURITY_KEY, "new_sca_severity_any_security"),
      Arguments.of(ScaMetrics.NEW_SCA_COUNT_ANY_ISSUE_KEY, "new_sca_count_any_issue"),
      Arguments.of(ScaMetrics.NEW_SCA_COUNT_VULNERABILITY_KEY, "new_sca_count_vulnerability"),
      Arguments.of(ScaMetrics.NEW_SCA_COUNT_LICENSING_KEY, "new_sca_count_licensing"),
      Arguments.of(ScaMetrics.NEW_SCA_COUNT_MALWARE_KEY, "new_sca_count_malware"),
      Arguments.of(ScaMetrics.NEW_SCA_COUNT_ANY_SECURITY_KEY, "new_sca_count_any_security"),
      ...
      Arguments.of(ScaMetrics.SCA_RATING_ANY_SECURITY_KEY, "sca_rating_any_security"),
      ...
      Arguments.of(ScaMetrics.SCA_SEVERITY_ANY_SECURITY_KEY, "sca_severity_any_security"),
      Arguments.of(ScaMetrics.SCA_COUNT_ANY_ISSUE_KEY, "sca_count_any_issue"),
      Arguments.of(ScaMetrics.SCA_COUNT_VULNERABILITY_KEY, "sca_count_vulnerability"),
      Arguments.of(ScaMetrics.SCA_COUNT_LICENSING_KEY, "sca_count_licensing"),
      Arguments.of(ScaMetrics.SCA_COUNT_MALWARE_KEY, "sca_count_malware"),
      Arguments.of(ScaMetrics.SCA_COUNT_ANY_SECURITY_KEY, "sca_count_any_security"));
  }
}
