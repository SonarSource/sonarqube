...
public class PopulateProfileKeyOfActivitiesTest {
  ...
  public void migration_update_activities_profile_key() throws SQLException {
    ...
    assertThat(countActivitiesWithProfile("first-profile-key")).isEqualTo(3);
    assertThat(countActivitiesWithProfile("second-profile-key")).isEqualTo(1);
    assertThat(countActivitiesWithProfile("third-profile-key")).isEqualTo(1);
  }
  ...
  public void migration_is_reentrant() throws SQLException {
    ...
    underTest.execute();
    assertThat(countActivitiesWithProfile("profile-key")).isEqualTo(1);
  ...
  private int countActivitiesWithProfile(String qualityProfileKey) {
    return db.countSql(String.format("select count(1) from activities where profile_key='%s'", qualityProfileKey));
  }
