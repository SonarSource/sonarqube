...
public class UserPermissionDaoTest {
  ...
  public void select_global_permissions() {
    OrganizationDto org2 = OrganizationTesting.insert(dbTester, newOrganizationDto());
  ...
  public void selectUserIds() {
    OrganizationDto org1 = OrganizationTesting.insert(dbTester, newOrganizationDto());
    OrganizationDto org2 = OrganizationTesting.insert(dbTester, newOrganizationDto());
