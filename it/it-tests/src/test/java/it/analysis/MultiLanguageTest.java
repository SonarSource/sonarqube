...
public class MultiLanguageTest {
  ...
  public void test_sonar_runner_inspection() {
    restoreProfile(orchestrator, "/analysis/MultiLanguageTest/one-issue-per-line.xml", null);
    restoreProfile(orchestrator, "/analysis/MultiLanguageTest/one-issue-per-line-xoo2.xml", null);
