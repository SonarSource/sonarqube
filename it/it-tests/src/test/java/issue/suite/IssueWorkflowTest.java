...
public class IssueWorkflowTest {
  ...
  public void issue_is_closed_as_removed_when_rule_is_disabled() throws Exception {
    ...
    SonarRunner analysis = SonarRunner.create(projectDir("issue/workflow"), "sonar.profile", "xoo-one-issue-per-line-profile");
    ...
    analysis = SonarRunner.create(projectDir("issue/workflow"), "sonar.profile", "empty");
    orchestrator.executeBuild(analysis);
